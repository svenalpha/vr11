...
function matchPath(pattern, pathname) {
  ...
  let params = compiledParams.reduce((memo, _ref, index3) => {
    let {
      paramName,
      isOptional
    } = _ref;
...
function _renderMatches(matches, parentMatches, dataRouterState, future) {
  ...
  return renderedMatches.reduceRight((outlet, match, index3) => {
    ...
    return dataRouterState && (match.route.ErrorBoundary || match.route.errorElement || index3 === 0) ? /* @__PURE__ */ reactExports.createElement(RenderErrorBoundary, {
...
function createRoutesFromChildren(children, parentPath) {
  ...
  let routes2 = [];
  reactExports.Children.forEach(children, (element, index3) => {
...
axios.default = axios;
function About() {
  const [userz, setUserz] = reactExports.useState([]);
  const doLoad = async () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "start of userz display" }),
    userz.map(
      (usar) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: usar.name }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: usar.age })
      ] }, usar.id)
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "end of userz display" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "strClass", children: "using strClass from   app.css  inside About pagee" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: module_StrClass, children: "using module_StrClass within curly brackets  inside About pagee" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: module_StrClass1, children: "using module_StrClass1 hhhhhhhhhh  inside About pagee" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: module_StrClass2, children: "using module_StrClass1 hhhhhhhhhh  inside About pagee" }),
...
function Env() {
  ...
  try {
    msg = define_process_env_default$1.MY_CUSTOM_SECRET || msg;
  } catch {
  }
...
function Error404$1() {
  ...
  try {
    msg = define_process_env_default.MY_CUSTOM_SECRET || msg;
  } catch {
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: msg });
}
...
const UseEffectFetchData = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "github users" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "users", children: users.map((user) => {
      const { id: id2, login, avatar_url, html_url } = user;
      return /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: avatar_url, alt: login }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: login }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: html_url, className: "strClass", children: "profile" })
        ] })
      ] }, id2);
    }) })
  ] });
...
function Extra() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Extra" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(UseEffectFetchData, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: addAndMultiply(1, 2, 3) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: multiplyAndAdd(1, 2, 3) })
  ] });
}
...
const WorkoutsContext = reactExports.createContext();
const workoutsReducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case "DELETE_WORKOUT":
      return { workouts: state.workouts.filter((w2) => w2._id !== action.payload._id) };
    case "UPDATE_WORKOUT":
...
const WorkoutsContextProvider = ({ children }) => {
  ...
  const [state, dispatch] = reactExports.useReducer(workoutsReducer, { workouts: null });
  console.log("in context/WorkoutsContext.jsx WorkoutsContextProvider post useReducer(workoutsReducer,{workouts: null })");
  return /* @__PURE__ */ jsxRuntimeExports.jsx(WorkoutsContext.Provider, { value: { ...state, dispatch }, children });
};
const useWorkoutsContext = () => {
  console.log("in hooks/useWorkoutsContext.jsx/useWorkoutsContext   pre useContext(");
  const context = reactExports.useContext(WorkoutsContext);
...
const UpdateWorkoutForm = ({ workout, doUpdate, setDoUpdate }) => {
  ...
  const [wout, setWout] = reactExports.useState(workout);
  const [title, setTitle] = reactExports.useState(workout.title);
  const [reps, setReps] = reactExports.useState(workout.reps);
  const [load, setLoad] = reactExports.useState(workout.load);
  const [idxx, setIdxx] = reactExports.useState(workout._id);
  const [error, setError] = reactExports.useState(null);
  const [emptyFields, setEmptyFields] = reactExports.useState([]);
  const handleSubmit = async (e) => {
    ...
    console.log("const json = ", json3);
    if (!response.ok) {
      setError(json3.error);
      console.log(" CreateWorkoutForm  json = ", json3);
      setEmptyFields(json3.emptyFields);
      console.log("CreateWorkoutForm json.emptyFields = ", json3.emptyFields);
      ...
      setLoad("");
      setReps("");
      dispatch({ type: "UPDATE_WORKOUT", payload: json3 });
      console.log("in UpdateWorkoutForm, patched, possibly. json =", json3);
      setDoUpdate(false);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "create", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "update an entry" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: " Exercise title" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: " Load in kg: " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        type: "number",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "btn", onClick: handleSubmit, children: "submit form" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "error", children: error })
  ] }) });
};
const WorkoutDisplayDetails = ({ workout }) => {
  const [doUpdate, setDoUpdate] = reactExports.useState(false);
  const { dispatch } = useWorkoutsContext();
  const handleClickDelete = async () => {
    const response = await fetch("/api/workout/" + workout._id, { method: "DELETE" });
    const json3 = await response.json();
    if (response.ok) {
      dispatch({ type: "DELETE_WORKOUT", payload: json3 });
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "workout-details", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "inside start WorkoutDisplayDetails.js" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: workout.title }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "load in kg: " }),
      workout.load
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: workout.createdAt }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: handleClickDelete, children: "delete" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setDoUpdate(true), children: "setDoUpdate" }),
    doUpdate && /* @__PURE__ */ jsxRuntimeExports.jsx(UpdateWorkoutForm, { workout, doUpdate, setDoUpdate }, workout._id),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "inside end WorkoutDisplayDetails.js" })
  ] }) });
};
const CreateWorkoutForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!response.ok) {
      ...
      setLoad("");
      setReps("");
      dispatch({ type: "CREATE_WORKOUT", payload: json3 });
      console.log("in WorkoutForm, new entry added. json =", json3);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { className: "create", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: "add a new entry" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { children: " Exercise title" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
...
function GetWorkouts() {
  ...
  const getAllWorkouts = async () => {
    ...
    if (response.ok) {
      console.log("in GetWorkouts, before dispatch is invoked. json =", json3);
      dispatch({ type: "SET_WORKOUTS", payload: json3 });
      console.log("in getAllWorkouts, workouts = ", workouts);
    }
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "GetWorkouts" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "iiiiiiiinside GetWorkouts" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "workouts", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "beginning inside GetWorkouts.jsx" }),
      workouts && workouts.map(
        (workout) => (
          // ie only fires if workouts is positive 
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: workout.title }) }, workout._id)
        )
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "ending inside GetWorkouts.jsx" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CreateWorkoutForm, {})
    ] }),
    "   ",
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "workouts", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "beginning loop to GetWorkouts/WorkoutDisplyDetails" }),
      workouts && workouts.map(
        (workout) => (
          // ie only fires if workouts is positive 
          /* @__PURE__ */ jsxRuntimeExports.jsx(WorkoutDisplayDetails, { workout }, workout._id)
        )
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { children: "end loop to GetWorkouts/WorkoutDisplyDetails" })
    ] }),
    "   "
  ] });
}
...
function Home$1() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "  a11/vr11   ver. 08          16:42   22/02/2024   " }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: addAndMultiply(1, 2, 3) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: multiplyAndAdd(1, 2, 3) })
  ] });
}
...
const pages = /* @__PURE__ */ Object.assign({ "./pages/About.jsx": __vite_glob_0_0, "./pages/Env.jsx": __vite_glob_0_1, "./pages/Error404.jsx": __vite_glob_0_2, "./pages/Extra.jsx": __vite_glob_0_3, "./pages/GetWorkouts.jsx": __vite_glob_0_4, "./pages/Home.jsx": __vite_glob_0_5, "./pages/ToProxy.jsx": __vite_glob_0_6 });
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { children: routes.map(
      ({ name, path }) => {
        if (name !== "Error404" && name !== "xxxUpdate") {
          return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { style: { color: "red" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: path, style: { color: "green" }, children: name }) }, path);
        }
      }
    ) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Routes, { children: routes.map(({ path, component: RouteComp }) => {
      ...
      if (path == "/test1" || path == "/api/workoutsx/testx")
        return /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path }, path);
      else
...
client.hydrateRoot(
  ...
  /* @__PURE__ */ jsxRuntimeExports.jsx(BrowserRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(WorkoutsContextProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
);
